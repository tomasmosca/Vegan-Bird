...
public class Vegetales {
	...
	public Vegetales(int x,int y, double angulo, double escala) {
		...
		brocoli = Herramientas.cargarImagen("brocoli.png");
		carrots = Herramientas.cargarImagen("carrot.png");
		corn = Herramientas.cargarImagen("corn.png");
		lettuce = Herramientas.cargarImagen("letuce.png");
		
	}
	
	public void dibujarB(Entorno entorno)
	{
		entorno.dibujarImagen(brocoli, x, y, angulo, escala);
	}
	
	public void dibujarCa(Entorno entorno)
	{
		entorno.dibujarImagen(carrots, x, y, angulo, escala);
	}
	
	public void dibujarCo(Entorno entorno)
	{
		entorno.dibujarImagen(corn, x, y, angulo, escala);
	}
	
	public void dibujarL(Entorno entorno)
	{
		entorno.dibujarImagen(lettuce, x, y, angulo, escala);
	}
